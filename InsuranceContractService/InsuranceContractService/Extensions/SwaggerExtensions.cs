...
namespace InsuranceContractService.Presentation.Extensions
{
    /// <summary>
    ...
    public static class SwaggerExtensions
    {
        ...
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services)
        {
            services
                .AddSwaggerGen(swagger =>
                {
                    ...
                    {
                        Title = "Insurance Contract Service API",
                        Description = "API para gerenciamento de contratos de seguros.",
                        Version = "v1"
                    });

                    swagger.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "InsuranceContractService.API.xml"));
                });
        ...
        public static WebApplication UseCustomSwagger(this WebApplication app)
        {
            if (app.Environment.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "InsuranceContractService API V1");
                });
            }
